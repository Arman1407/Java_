...
public class task#1 {
    public static void main(String[] args) {
        ...
        phonBook.put("Коля", List.of("8 926 333 33 33", "8 926 222 22 99"));
        phonBook.put("Юра", List.of("8 926 333 33 55", "8 926 222 22 00"));
        phonBook.put("Иван", List.of("8 926 333 33 66", "8 926 222 22 44"));
        phonBook.put("Юля", List.of("8 926 333 33 77", "8 926 222 22 11"));
        phonBook.put("Катя", List.of("8 926 333 33 88", "8 926 222 22 22"));
    ...
    public static Map<String, List<String>> add(Map<String, List<String>> phonBook) {
        System.out.println("Если хотите выйте или перестать вводить номера, введите 'stop'");
        System.out.println("Введите имя: ");
        String name = scanner();
